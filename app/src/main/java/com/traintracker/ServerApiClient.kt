    ...
    suspend fun getKbStation(crs: String): KbStation? = withContext(Dispatchers.IO) {
        try {
            ...
            KbStation(
                ...
                stationOperator          = o.optString("stationOperator"),
                ...
                heightAdjustedCounter    = o.optString("heightAdjustedCounter"),
                rampForTrainAccess       = o.optString("rampForTrainAccess"),
                accessibleTaxis          = o.optString("accessibleTaxis"),
                ...
                telephones               = o.optString("telephones"),
                postBox                  = o.optString("postBox"),
                shops                    = o.optString("shops"),
                ...
                cycleHire                = o.optString("cycleHire"),
                airport                  = o.optString("airport"),
                carParking               = o.optString("carParking"),
                carParkName              = o.optString("carParkName"),
                carParkOperator          = o.optString("carParkOperator"),
                carParkTotal             = o.optString("carParkTotal"),
